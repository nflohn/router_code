...
class l3_switch (EventMixin):
  ...
  def _handle_PacketIn (self, event):
    ...
    self.arpTable[1]={}
    self.arpTable[1][IPAddr('10.0.1.100')] = Entry(1, EthAddr('00:00:00:00:00:01'))
    self.arpTable[1][IPAddr('10.0.2.100')] = Entry(2, EthAddr('00:00:00:00:00:02'))
    self.arpTable[1][IPAddr('10.0.3.100')] = Entry(3, EthAddr('00:00:00:00:00:03'))
    #return address library
    returnAddr = {IPAddr('10.0.1.100') : IPAddr('10.0.1.1'), IPAddr('10.0.2.100') : IPAddr('10.0.2.1'), IPAddr('10.0.3.100') : IPAddr('10.0.3.1')}
        ...
        if a.hwtype == arp.HW_TYPE_ETHERNET:
          if a.protosrc != 0:
            ...
            if a.opcode == arp.REQUEST:
              ...
              if match.nw_dst == IPAddr('10.0.1.1'):
              ...
              elif match.nw_dst == IPAddr('10.0.3.1'):
                r = arp()
                r.opcode = arp.REPLY
                r.hwdst = a.hwsrc
                r.protosrc = IPAddr('10.0.3.1')
                r.protodst = a.protosrc
                r.hwsrc = dpid_to_mac(dpid)
                r.hwtype = a.hwtype
                r.prototype = a.prototype
                ...
                msg.in_port=inport
                event.connection.send(msg)
                log.debug("answered ARP for router interface at 10.0.3.1")
                return
